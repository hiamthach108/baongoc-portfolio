    ...
    <div className="py-6">
      ...
      <AnimFade direction="up" className="content-container">
        <p className="my-4 w-full mx-auto text-sm">
          ...
          language, translating emotions and experiences into performances that resonate
          with others. Whether collaborating on intricate choreography or sharing the joy
          of movement through teaching, I’ve found that dance fosters a deep sense of
          connection and belonging. It’s more than just performing—it&apos;s a constant
          journey of growth and discovery. I’m always seeking new ways to push my creative
